...
def send_project_email(session, project=None, project_id=None):
    ...
    try:
        ...
        email_body = config["DATA_AVAILABLE_NOTIFICATION"]["EMAIL_BODY"].format(users=first_names, project_name=project.name, project_id=project.description, emails=", ".join(recipients))
